...
echo "#define OPENCRAFT_SHORT_VER  \"opencraftd v\" OPENCRAFT_VERSION" >>include/version.h
echo "#define OPENCRAFT_LONG_VER   \"OpenCraft opencraftd version \" OPENCRAFT_VERSION \" build \" OPENCRAFT_BUILD " >>include/version.h
