...
int main( int argc, char **argv )
{
    ...
    /* this is wrong, the SDL_GL_ macros defined in SDL_video.h are for
     * operating on your opengl context using SDL_GL_SetAttribute() and
     * GetAttribute(), they are not SDL_SetVideoMode() bits */
