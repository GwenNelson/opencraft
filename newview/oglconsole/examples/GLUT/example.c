...
int main ( int argc, char** argv )   // Create Main Function For Bringing It All Together
{
  ...
  // Look how useless the comment is in the line above! i fucking hate nehe with
  // all of my heart. no worse tutorials exist anywhere i swear to god. and WTF
  // is NEON HELIUM !? jesus christ

  glutInitDisplayMode ( GLUT_RGBA | GLUT_DOUBLE | GLUT_DEPTH ); // Display Mode
  // yeah did anybody else notice that this fucker didn't specify depth testing!
  glutInitWindowSize  ( 640, 480 ); // If glutFullScreen wasn't called this is the window size
  glutCreateWindow    ( "Don't visit NeHe's website" ); // Window Title (argv[0] for current directory as title)
